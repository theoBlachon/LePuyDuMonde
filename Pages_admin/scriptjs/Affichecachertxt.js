...
function afficherg(){
	...
	if(mode==0){
		...
		document.getElementById("imgpass").src="imagefallout/handypasswordG.png"; // change l'image de base
		...
		document.getElementById("imgpass").src="imagefallout/handypassword.png"; //modifie l'image à nouveau
		mode=0;
	}
} 
