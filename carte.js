...
const japonIcon = new LeafIcon({iconUrl: 'images/japonicon.png'});
const mexiqueIcon = new LeafIcon({iconUrl: 'images/mexiqueicon.png'});
const indeIcon = new LeafIcon({iconUrl: 'images/indeicon.webp'});
const egypteIcon = new LeafIcon({iconUrl: 'images/egypteicon.png'});
const parkIcon = new ParkIcon({iconUrl: 'images/parkicon.png'});
const gareIcon = new ParkIcon({iconUrl: 'images/gareicon.png'});
