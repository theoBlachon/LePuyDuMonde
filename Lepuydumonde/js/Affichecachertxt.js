...
function afficherg(){
	...
	if(mode==0){
		...
		document.getElementById("imgpass").src="images/visible.png"; // change l'image de base
		...
		document.getElementById("imgpass").src="images/invisible.png"; //modifie l'image à nouveau
		mode=0;
	}
} 
